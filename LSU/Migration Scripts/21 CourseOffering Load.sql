...
--GO
SELECT *
INTO [EDUCPROD].dbo.CourseOffering_LOAD
FROM [EDUCPROD].[dbo].[21_EDA_CourseOffering] C
...
EXEC SF_TableLoader 'Upsert:BULKAPI','EDUCPROD','CourseOffering_LOAD','one_Destiny_One_ID__c'
