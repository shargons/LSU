...
FROM EDUCPROD.[dbo].[08_EDA_Student] S
LEFT JOIN
EDUCPROD.dbo.LearnerProgram L
...
FROM EDUCPROD.dbo.LearnerProgram_Missing_Insert_2 A
INNER JOIN
...
FROM [EDUCPROD].dbo.LearnerProgram_Missing_Insert_3 A
INNER JOIN
edaprod.dbo.hed__Affiliation__c B
ON A.LSU_Affiliation__c = B.ID
LEFT JOIN
...
EXEC SF_TableLoader 'Insert:BULKAPI','EDUCPROD','LearnerProgram_Missing_Insert_2'
