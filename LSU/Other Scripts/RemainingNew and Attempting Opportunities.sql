...
--GO
SELECT *
INTO EDUCPROD.[dbo].[Opportunity_LOAD_NEW]
...
ALTER TABLE EDUCPROD.[dbo].[Opportunity_LOAD_NEW]
...
SELECT * FROM EDUCPROD.[dbo].[Opportunity_LOAD_NEW]

EXEC SF_TableLoader 'Insert:BULKAPI','EDUCPROD','Opportunity_LOAD_NEW_3'
